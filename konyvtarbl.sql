...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Nov 24. 09:46
...
--
CREATE DATABASE IF NOT EXISTS `konyvtarbl` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `konyvtarbl`;
...
INSERT INTO `konyv` (`konyv_id`, `konyv_nev`, `konyv_iro`, `konyv_mufaj`, `konyv_kiadaseve`, `konyv_oldalszam`, `konyv_kiado`, `kotelezo`) VALUES
(10, 'Főnix ', 3, 2, 2021, 0, 2, 0),
(11, 'Légy jó mindhalálig', 4, 2, 1920, 281, 2, 1),
(12, 'Szent Péter esernyője', 1, 2, 1895, 341, 1, 1),
(13, 'Erdély aranykora', 2, 2, 1852, 320, 1, 0),
(14, 'Rómeó és Júlia', 5, 1, 1597, 221, 1, 1);
